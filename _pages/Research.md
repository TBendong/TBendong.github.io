...
<div>
  ...
  <ul>
    <li><b>Inverse Problem: Dynamic Power System Modeling</b>: This module models loads and inverter-based resources (IBRs) using sensor measurements. It involves parameter estimation for these components, which is fundamental for operators to conduct accurate power system analysis.</li>
  ...
  <p>
    Through broad collaborations with industry and national laboratories, including <b>NREL, LLNL, PNNL, ANL, and ISO New England</b>, my research bridges theory and real-world applications. Some of these modules have been validated in practice; for example, the load modeling technique was successfully applied to fault measurements from an utility company in the southern United States.
  </p>
</div>
